# CA02
For this assignment, I coonnected to my dataset using Google Colab. I then followed the guide to go through and solve the code to mainly execute the following
